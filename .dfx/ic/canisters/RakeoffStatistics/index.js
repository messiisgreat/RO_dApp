...
import { idlFactory } from './ROStatistics.did.js';
export { idlFactory } from './ROStatistics.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ROSTATISTICS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ROStatistics.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ROStatistics canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ROStatistics.did.js")._SERVICE>}
 */
export const ROStatistics = createActor(canisterId);
